...
namespace Ghostly.DAL.SQL
{
    ...
    public partial class GhostlyXEntities : DbContext
    {
        public GhostlyXEntities()
            : base("name=GhostlyXEntities")
        {
        }
        ...
        public virtual DbSet<Deliverability> Deliverabilities { get; set; }
        public virtual DbSet<DeliveryChannel> DeliveryChannels { get; set; }
        public virtual DbSet<fdc_branded_food> fdc_branded_food { get; set; }
        public virtual DbSet<fdc_food> fdc_food { get; set; }
